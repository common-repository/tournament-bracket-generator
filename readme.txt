...
Tags: sport, sports, tournament, bracket, generator, plugin, shortcode, event, playoffs, superbowl, world cup, football, soccer, basketball
Requires at least: 4.6.1
Tested up to: 4.7.1
Stable tag: 1.0.0
License: GPLv2 or later

Tournament Bracket Generator provides an easy way to create a stunning bracket for any sport of event.

== Description ==

https://www.youtube.com/watch?v=hapFIqkCHTI
...
1. Shows the settings page for Tournament Bracket Generator
2. Shows a preview of the bracket generated for configuration
3. Shows the next round of the bracket generated for configuration
4. Shows the shortcode for Tournament Bracket Generator
5. Shows the bracket on a webpage
6. Shows a non completed bracket on a webpage
